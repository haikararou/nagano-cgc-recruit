...
<main class="l-main">
  <div class="l-hero">
    ...
    <img src="<?php echo $path; ?>assets/img/people/main.png" alt="">
  </div>
    ...
    <section class="l-wrapper__container l-wrapper--right p-people">
      ...
      <div class="p-text-box" id="anchor--02">
        <div class="p-people--bnr">
          ...
          <figure class="p-people--bnr--people"><img src="<?php echo $path; ?>assets/img/people/zadankai_people.png" alt=""></figure>
        </div>
      </div>
    </section>
  </section>
