...
<main class="l-main">
  ...
  <section class="l-wrapper__outer l-wrapper">
    <div>
      ...
      <h2 class="c-text--h2 --peopel">中島 菜々子<span> （1年目 松本営業部業務第1課）</span></h2>
    </div>
  </section>

  <div class="l-hero--people">
    <figure>
      <img src="<?php echo $path; ?>assets/img/people/people01/main.png" alt="">
      <figcaption>
        明朗快活で<br>
        場を明るくする<br>
        期待の新人職員
  ...
  <section class="l-wrapper__outer2 l-wrapper">
    ...
    <section class="l-wrapper__container l-wrapper--right --peopel p-people">
      ...
      <div class="p-text-box">
        ...
        <p>現在は、保証稟議書の作成などを行う保証業務や、郵便物開封、公用車管理といった庶務を中心に行っています。先輩方と一緒に、お客様の経営支援に赴くこともあります。一年目なので、業務の基礎的なことを教わっている最中です。<br>
          ...
          <img src="<?php echo $path; ?>assets/img/people/people01/pic_01.png" alt="">
      </div>
      ...
      <div class="p-text-box">
        ...
        <p>協会の魅力は、お客様にとってのメリットを一番に考えられることです。経営支援などで関わった企業が実際に活躍されているのを見ると、やりがいを感じます。経営支援に赴くことは、今の楽しみのひとつです。<br>
          ...
          <img src="<?php echo $path; ?>assets/img/people/people01/pic_02.png" alt="">
      </div>
    ...
    <div class="p-text-box">
      ...
      <section class="p-people--intro p-people--intro--other">
        <a href="<?php echo $path; ?>/people/people02/" class="p-people--intro--div intro_02">
          <figure>
        ...
        <a href="<?php echo $path; ?>/people/people05/" class="p-people--intro--div intro_05">
          <figure>
