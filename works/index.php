  ...
  <section class="l-wrapper__outer2 l-wrapper">
    ...
    <section class="l-wrapper__container l-wrapper--right p-works">
      <div class="p-text-box">
        <p>協会には８つの営業店、３つの部、１室があり、それぞれが連携し合ってお客様を支えています。各部署がどんな仕事をしているのかを、詳しくご紹介します。</p>
      </div>
      <div class="p-text-box" id="anchor--01">
        <h2 class="c-text--h2">営業店</h2>
        <p>実際にお客様と対話し、課題の解決策を一緒に考えます。保証相談を受け、現状分析やヒアリングから審査を行う「保証審査業務」、保証をご利用いただいている中小企業の経営・再生支援、創業者のフォローアップを行う「経営支援」、代位弁済（※）後の債務に係る管理や回収といった、お客様の債務解決に関わる「管理回収業務」等を行います。<br>
      ...
      <div class="p-text-box" id="anchor--02">
        ...
        <p>営業店で行う「保証審査業務」と「管理回収業務」を統括する部署です。保証審査に関する相談業務、求償権（※）の管理・回収の統括や指導を行っています。<br>
